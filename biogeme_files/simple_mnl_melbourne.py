...
b_bicycle = Beta('b_bicycle', b_bicycle, -100, 100, fixed_params)
b_car = Beta('b_car', b_car, -100, 100, fixed_params)
b_pt1 = Beta('b_pt1', b_pt1, -100, 100, fixed_params)
b_pt2 = Beta('b_pt2', b_pt2, -100, 100, fixed_params)
b_pt3 = Beta('b_pt3', b_pt3, -100, 100, fixed_params)

cost_bicycle = Beta('cost_bicycle', cost_bicycle, -100, 100, fixed_params)
cost_car = Beta('cost_car', cost_car, -100, 100, fixed_params)
cost_pt1 = Beta('cost_pt1', cost_pt1, -100, 100, fixed_params)
cost_pt2 = Beta('cost_pt2', cost_pt2, -100, 100, fixed_params)
cost_pt3 = Beta('cost_pt3', cost_pt3, -100, 100, fixed_params)
cost_walk = Beta('cost_walk', cost_walk, -100, 100, fixed_params)
